...
html_text = requests.get("https://www.linkedin.com/jobs/search?trk=guest_homepage-basic_guest_nav_menu_jobs&position=1&pageNum=0").text
...
for job in jobs:
    ...
    company_location = loc_and_posted.find("span",class_ = "job-search-card__location").text.replace("\n","").strip()
